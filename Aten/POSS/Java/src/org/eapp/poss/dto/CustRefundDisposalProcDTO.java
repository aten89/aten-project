 ...
 *
 */
public class CustRefundDisposalProcDTO implements java.io.Serializable, Comparable<CustRefundDisposalProcDTO> {
	...
	@Override
	public int compareTo(CustRefundDisposalProcDTO o) {
