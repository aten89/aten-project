...
public class DataInvalidEvent implements IActionHandler {
     ...
     * 
     */
    private static final long serialVersionUID = -808441647330032401L;
    /**
     * 日志
     */
	...
	public void execute(Execution exe) throws Exception {
		...
		custRefundBiz.txInvalidCustRefund(formId);
		log.info("exe org.eapp.poss.flow.handler.custRefund.DataInvalidEvent");
	}
