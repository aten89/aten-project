 ...
 */
function loadCusts() {
	var url = CRM_PATH + "m/customer/autocompdata?multipleCustomerStatus=3&pageSize=500&format=json&jsoncallback=?";
...
function getPaymentJson(){
	...
	payment.custId = $.trim($("#custId").val());
	payment.custName = $.trim($("#custName").val());
