...
<script type="text/javascript" src="page/operationsManage/paymentRegister/paymentApprove.js"></script>
<title>划款审批</title>
</head>
<body class="tabBd">
<input type="hidden" id="custPaymentId" value="${custPayment.id }" />
<input type="hidden" id = "filePath" value="${custPayment.paymentReceipt.filePath }"/>
  ...
  <table border="0" width="100%" align="center" cellpadding="0"  cellspacing="1">
    <tr>
      ...
      <tr>
		...
		<td><input id="payAmount" type="text" maxlength="40" class="ipt05" value="${custPayment.transferAmount }" /></td>
		<td class="tit"><span class="cRed">*</span>划款金额大写：</td>
		<td>
			<div id="payAmountCapital">${custPayment.transferAmountCapital }</div>
		</td>
      </tr>
      <tr>
