...
<script type="text/javascript" src="page/operationsManage/refuncApplication/refuncApplicationToDoList.js"></script>
<input id="status" type="hidden" value="${param.status }" />
<input id="hidModuleRights" type="hidden" value="<eapp:right key='REFUND_TODO'/>" />
<!-- 工具栏 -->
<div class="addTool">
	<div class="t01 t_f01">
