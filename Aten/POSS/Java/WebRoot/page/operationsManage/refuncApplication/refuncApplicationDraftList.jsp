...
<script type="text/javascript" src="page/operationsManage/refuncApplication/refuncApplicationDraftList.js"></script>
<input id="status" type="hidden" value="${param.status }" />
<input id="hidModuleRights" type="hidden" value="<eapp:right key='REFUNC_APPLICATION'/>" />

<!-- 工具栏 -->
<div class="addTool">
	<div class="t01">
		<input type="button" class="add_btn" id="addCustRefund" />
	</div>
</div>
...
<div class="soso soRow2" >
	<div class="t01">
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>申请时间从：</td>
				<td><input id="applyTimeBegin" type="text" maxlength="40" class="ipt05 invokeBoth" />&nbsp;&nbsp;</td>
				<td>到：</td>
				<td><input id="applyTimeEnd" type="text" maxlength="40" class="ipt05 invokeBoth" />&nbsp;&nbsp;</td>
				<td>客户名称：</td>
				<td>
			...
			<tr style="height:26px">
				<td>客户经理：</td>
				<td>
					<!-- <input id="saleManId" type="text" maxlength="40" class="ipt05" />&nbsp;&nbsp; -->
				...
				<td>产品项目：</td>
				<td colspan="3">
					<!-- <input id="prodId" type="text" maxlength="40" class="ipt05" />&nbsp;&nbsp; -->
...
<table id="waitVisitCustomerTab" width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tbody id="refuncApplicationDraftList">
 </tbody>
</table>
</div>
<!--翻页-->
