...
<script type="text/javascript" src="page/operationsManage/refuncApplication/refuncApplicationArchList.js"></script>
<input id="status" type="hidden" value="${param.status }" />
<input id="hidModuleRights" type="hidden" value="<eapp:right key='REFUND_ARCH'/>" />
<!-- 工具栏 -->
...
<table id="waitVisitCustomerTab" width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tbody id="refuncApplicationArchList">
 </tbody>
</table>
</div>
<!--翻页-->
