...
<script type="text/javascript" src="page/operationsManage/refuncApplication/viewRefuncApplication.js"></script>
<title></title>
</head>
<body class="crmBd">
...
<div class="addCon openWinW03" style="margin-left: auto;margin-right: auto;">
  <table width="100%" border="0" align="left" cellpadding="0"  cellspacing="1">
    ...
    <tr>
		...
		<td><input readonly="readonly" name="applyTime" id="applyTime" disabled="disabled" type="text" class="invokeBoth" value="${!empty custRefund.applyTimeStr ? custRefund.applyTimeStr : nowDate }"/></td>
	</tr>
    <tr>
      	<td class="tit"><span class="cRed">*</span>流程标题：</td>
		<td colspan="3"><input id="flowTitle" type="text" maxlength="100" disabled="disabled" class="ipt05" style="width: 100%;" value="${custRefund.flowTitle }"/></td>
    </tr>
    <tr>
...
<div class="oppBtnBg">
	...
	<span id="commitBut">  
		<input class="allBtn" type="button" value="关闭" />
	</span>
</div>
</body>
</html>