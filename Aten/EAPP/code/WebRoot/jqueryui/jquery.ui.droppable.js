...
//				this.element.triggerHandler("dropover", [e, this.ui(draggable)], this.options.over);
				//支持高版本JQUERY
				this.element.triggerHandler("dropover", [e, this.ui(draggable)]);
				if($.isFunction(this.options.over)) this.options.over(e, this.ui(draggable));
			}
...
//				this.element.triggerHandler("dropout", [e, this.ui(draggable)], this.options.out);
				//支持高版本JQUERY
				this.element.triggerHandler("dropout", [e, this.ui(draggable)]);
				if($.isFunction(this.options.out)) this.options.out(e, this.ui(draggable));
			}
...
//				this.element.triggerHandler("drop", [e, this.ui(draggable)], this.options.drop);
				//支持高版本JQUERY
				this.element.triggerHandler("drop", [e, this.ui(draggable)]);
				if($.isFunction(this.options.drop)) this.options.drop(e, this.ui(draggable));
			}
		...
		activate: function(e) {
			...
			if(draggable) {
//				this.element.triggerHandler("dropactivate", [e, this.ui(draggable)], this.options.activate);
				//支持高版本JQUERY
				this.element.triggerHandler("dropactivate", [e, this.ui(draggable)]);
				if($.isFunction(this.options.activate)) this.options.activate(e, this.ui(draggable));
			}
		...
		deactivate: function(e) {
			...
			if(draggable) {
//				this.element.triggerHandler("dropdeactivate", [e, this.ui(draggable)], this.options.deactivate);
				//支持高版本JQUERY
				this.element.triggerHandler("dropdeactivate", [e, this.ui(draggable)]);
				if($.isFunction(this.options.deactivate)) this.options.deactivate(e, this.ui(draggable));
			}
