...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" style="min-width:240px;">
	...
	<tr>
		<td class="tit">是否结束流程</td>
		<td id="endFlowTD"><input type="radio" name="endFlow" value="true"/> 是&nbsp;&nbsp;
			<input type="radio" name="endFlow" value="false" checked/> 否</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><div id="attr_nodeEnterEvent"></div></td>
	</tr>
</table>