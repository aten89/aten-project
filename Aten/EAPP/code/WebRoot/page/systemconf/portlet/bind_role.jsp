			   ...
			   <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="tabNone">
				  <tr>
					<td valign="top" width="280" style="height:305px; padding:0px 0 0">
						<div class="mkdzTip">已绑定角色</div>
						<div class="mkdz" style=" border:none">
						<select id="bindedRole" name="bindedRole" size="1" multiple="multiple" class="dzbdSel01" style="height:260px; width:280px">
						</select>
						</div>
					</td>
					<td>
					   ...
					   &nbsp;&nbsp;&nbsp;<input id="delBind" name="delBind" type="button" value="删除&gt;&gt;" class="allBtn" style="margin:6px 0px"/>
						...
						<td valign="top" width="280"  style="height:305px; padding:0px 0 0">
						<div class="mkdzTip">未绑定角色：<input id="rolename" name="rolename" maxlength="40" type="text" class="ipt01" style="width:118px" value=""/>&nbsp;<input id="searchRole" type="button" value="搜索" class="allBtn subsoW" /></div>
						<div class="mkdz" style=" border:none">
						<select id="role" name="role" size="1" multiple="multiple" class="dzbdSel01" style="height:260px; width:280px">
						</select>
						</div>
					</td>
				  </tr>
...
<!--接口帐号 绑定 end-->
<script type="text/javascript" src="page/systemconf/portlet/bind_role.js"></script>