...
<script type="text/javascript" src="page/systemconf/portlet/default_portlet.js"></script>
</head>
...
<form onsubmit="return false;">
  <div class="portletLeft">
	  <h1 class="headDefault">默认显示门户</h1>
  ...
  <div class="portletRight">
	  <h1 class="headDefault">未选中的门户</h1>
	  <div class="portPadd2">
...
<!--门户定制 end-->
<div class="addTool2">
    <input id="saveDefaultPortletConfig" type="button" value="保存" class="allBtn"/>
</div>
</body>
</html>