				   ...
				   <table border="0" cellspacing="0" cellpadding="0" class="tabNone">
					  <tr>
						<td valign="top" width="380">
						 <div class="mkdzTip" style="padding:6px 0 0 10px">已绑定的权限</div>
							<div class="mkdz">
						    <div class="bindUser" style="width:378px; height:366px">
							   ...
							   <thead>
								  <tr>
									...
									<th nowrap width="144">子系统</th>
									<th nowrap width="80">模块名称</th>
...
<!--角色 绑定权限 end-->
<script type="text/javascript" src="page/usermanage/role/bind_right.js"></script>