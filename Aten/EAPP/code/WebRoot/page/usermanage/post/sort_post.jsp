  ...
  <tr>
	<td>
	   ...
	   <table width="300" align="center" border="0" cellspacing="0" cellpadding="0" class="tabNone">
		  <tr>
			<td width="230">
			<select id="subPost" name="subPost" size="1" multiple="multiple" class="dzbdSel01" style="height:295px">
			</select>
			</td>
			<td width="70">
...
<!--群组  排序 end-->
<script type="text/javascript" src="page/usermanage/post/sort_post.js"></script>