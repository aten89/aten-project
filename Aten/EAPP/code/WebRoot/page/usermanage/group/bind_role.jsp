			   ...
			   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabNone">
				  <tr>
					<td valign="top" width="255" style="height:305px; padding:0px 0 0">
					  <div class="mkdzTip" style="padding:6px 0 0 10px">已绑定角色</div>
					   <div class="mkdz" style="border:none">
					   <select id="bindedRole" name="" size="1" multiple="multiple" class="dzbdSel01" style="height:260px; width:255px">
					   </select>
					   </div>
					</td>
					...
					<td valign="top" width="255"  style="height:305px; padding:0px 0 0">
						<div class="mkdzTip">未绑定角色：<input id="rolename" name="rolename" maxlength="40" type="text" class="ipt01" style="width:100px" value=""/>&nbsp;<input id="searchRole" type="button" value="搜索" class="allBtn subsoW" /></div>
						<div class="mkdz" style="border:none">
							<select id="role" name="" size="1" multiple="multiple" class="dzbdSel01" style="height:260px; width:255px">
							</select>
						</div>
					</td>
				  </tr>
...
<!--群组 添加角色 end-->
<script type="text/javascript" src="page/usermanage/group/bind_role.js"></script>