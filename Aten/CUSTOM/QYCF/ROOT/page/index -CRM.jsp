...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body onContextMenu="return false;">
  	...
  	<!--CALLCENTER-->
  	<iframe width="100" height="100" src="page/callcenter_page.jsp"></iframe>
  	<!--CALLCENTER-->
  	...
  	<div style="width:250px;height:20px;z-index:998;position:absolute;top:15px;left:35%;cursor:pointer;">
  		<input type="button" value="示闲" onclick='top.CRM_CALLCENTER_OBJ.showIdle();' class="allBtn" style="height:25px"/>
  		<input type="button" value="示忙" onclick='top.CRM_CALLCENTER_OBJ.showBusy();' class="allBtn" style="height:25px"/>
  		<input type="button" value="静音" onclick='top.CRM_CALLCENTER_OBJ.showMute();' class="allBtn" style="height:25px"/>
  		<input type="button" value="取消静音" onclick='top.CRM_CALLCENTER_OBJ.cancelMute();' class="allBtn" style="height:25px"/>
  	</div>
