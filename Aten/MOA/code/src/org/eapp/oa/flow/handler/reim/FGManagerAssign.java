 ...
 * @version Nov 30, 2008
 */
public class FGManagerAssign implements IAssignmentHandler {
	private static final Log log = LogFactory.getLog(FGManagerAssign.class);
	/**
	 * 
	 */
	...
	public void assign(IAssignable assignable, Execution exe) throws Exception {
		...
		PostInfo ppDto = HandlerHelper.getGroupHighLevelPost(groupName);
		if (ppDto == null) {
			return;
		}
