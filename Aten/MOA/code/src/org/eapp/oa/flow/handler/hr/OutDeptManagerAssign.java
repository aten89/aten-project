 ...
 * @version Nov 30, 2008
 */
public class OutDeptManagerAssign implements IAssignmentHandler {
	private static final Log log = LogFactory.getLog(OutDeptManagerAssign.class);
	/**
	 * 
	 */
	...
	public void assign(IAssignable assignable, Execution exe) throws Exception {
		ContextVariable var = exe.getFlowInstance().getVariable(SysConstants.FLOW_VARNAME_OUTGROUPNAME);
