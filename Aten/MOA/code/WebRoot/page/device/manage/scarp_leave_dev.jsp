...
<script type="text/javascript" src="page/device/manage/scarp_leave_dev.js"></script>
  ...
  <div class="addCon">
    <table border="0" cellpadding="0"  cellspacing="1" width="100%">
      ...
      <tr>
        ...
        <td class="field"><span id="buyTypeStr"></span></td>
      ...
      <tr>
        ...
        <td colspan="3"><div style="width:139px">
