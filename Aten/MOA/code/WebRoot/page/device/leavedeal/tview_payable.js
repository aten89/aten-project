...
$(initEquipmentInfoLeavePayableHandle);

function initEquipmentInfoLeavePayableHandle() {
...
function commitDispose(){
	...
	$("div.feesSp").each(function(){
		...
		if($("input[name='inDate']", this).size() != 0 && $("input[name='inDate']", this).val() == ""){ 
			$.alert("编号为“" + deviceNO + "”的设备回购款到账日期不能为空！");
			passList = false;
			return false;
		}
