...
<script type="text/javascript" src="page/device/leavedeal/tview_compcfm.js"></script>
<title>离职设备处理单</title>
</head>
<body class="bdNone">
  ...
  <div class="feesSp fsMar">
    <table cellspacing="0" cellpadding="0" border="0" width="100%" >
      ...
      <tr>
        ...
        <td width="320">${list.device.buyTypeName }</td>
      </tr>
      <tr>
                    ...
                    <div class="shadowCon shadowPadd">
                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        <tr>
                          ...
                          <th class="sbRight" width="15%">已提折旧</th>
                          <td width="50%"><fmt:formatNumber value="${list.depreciation }" pattern="0.00"/>元</td>
                        </tr>
                        <!-- 综合部审批页面，只显示出处理方式是离职回购的设备，拿走和退库在该页面不显示 -->
  	  					<c:if test="${list.dealType == 'LEAVE_DISPOSE_BACKBUY'}">
                        <tr>
                          <th class="sbRight"><span class="cRed">*</span>回购价格</th>
                          <td width="135"><input name="buyPrice" type="text" maxlength="12" class="ipt05 iptSo" value="<fmt:formatNumber value="${list.buyPrice }" pattern="0.00"/>"/>元</td>
                          <th class="sbRight"><span class="cRed">*</span>不回购价格</th>
                          <td><input name="noBuyPrice" type="text" maxlength="12" class="ipt05 iptSo" value="<fmt:formatNumber value="${list.noBuyPrice }" pattern="0.00"/>"/>元</td>
                        </tr>
                        <tr>
                          <th class="sbRight"><span class="cRed">*</span>预期付款日期</th>
                          <td width="135" colspan="3"><input type="text" name="planPayDate" readonly="readonly" class="invokeBoth"  style="width:65px" value="<fmt:formatDate value="${list.planPayDate }" pattern="yyyy-MM-dd"/>"/></td>
                        </tr>
                        </c:if>
                      </table>
                    </div>
