...
<script type="text/javascript" src="page/device/leavedeal/tview_hr.js"></script>
                  ...
                  <div class="shadow04">
                    <div class="shadowCon shadowPadd">
                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        <tr>
                          <th width="80"  class="sbRight">设备余值</th>
                            ...
                            <div class="con01">
                              ...
                              <div class="sptgTime" style="width:494px;">
                                <div style="float:left; width:198px"><span style="float:left"><label class="cRed">*</label>入司时间：</span>
                                  <input id="enterCompanyDate" style="float:left" type="text" maxlength="100" readonly="readonly" class="invokeBoth" value="<fmt:formatDate value="${form.enterCompanyDate }" pattern="yyyy-MM-dd"/>"/>
                                </div>
                                <div style="float:right"><label class="cRed">*</label>请填写员工工龄：
                                  <input id="workYear" type="text" class="ipt01 spTimeIpt" value="" maxlength="6" value="${form.workYear }"/>
                                  年</div>
                              </div>
                              <div class="clear"></div>
                            </div>
