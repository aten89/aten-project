...
<script type="text/javascript" src="page/device/leavedeal/tview_payable.js"></script>
<title>离职设备处理单</title>
</head>
<body class="bdNone">
...
<div class="tabMid"> 
  ...
  <div class="feesSp fsMar">
    <table cellspacing="0" cellpadding="0" border="0" width="100%" >
      ...
      <c:if test="${list.dealType == 'LEAVE_DISPOSE_BACKBUY' && list.buyFlag}">
      <tr>
        <td colspan="7" style="padding:0 5px"><ul class="allInfotip atBk">
            <li>该设备已回购，请填写回款购到账日期</li>
          </ul></td>
      </tr>
      </c:if>
      <tr>
                  ...
                  <div class="shadow04">
                    <div class="shadowCon shadowPadd">
                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                      	<tr>
                          <th class="sbRight" width="100">设备余值</th>
                          <td width="130"><fmt:formatNumber value="${list.remaining }" pattern="0.00"/>元</td>
                          <th class="sbRight">已提折旧</th>
                          <td width="480"><fmt:formatNumber value="${list.depreciation }" pattern="0.00"/>元</td>
                        </tr>
                        ...
                        <tr>
                          <th class="sbRight"><span class="cRed">*</span>回购款到账日期</th>
                          <td colspan="3"><input type="text" maxlength="100" name="inDate" readonly="readonly" class="invokeBoth" value="<fmt:formatDate value="${list.inDate }" pattern="yyyy-MM-dd"/>"/></td>
                        </tr>
                        </c:if>
                        </c:if>
                      </table>
