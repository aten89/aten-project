...
<script type="text/javascript" src="page/device/leavedeal/tview_ceo.js"></script>
<title>离职设备处理单</title>
</head>
<body class="bdNone">
...
<div class="tabMid"> 
  ...
  <!-- 总裁审批页面，只显示出处理方式是离职回购的设备，拿走和退库在该页面不显示 -->
                  ...
                  <div class="shadow04">
                    <div class="shadowCon shadowPadd">
                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <c:if test="${not empty list.inDate }">
	                        <tr>
...
<div class="addTool2">
  <input type="hidden" id="taskInstanceID" name="tiid" value="${param.tiid }"/>
	...
	<c:if test="${form.formType=='1' }" >
	  <c:if test="${param.flag=='compconfirm'}" >
