...
<script type="text/javascript" src="page/device/allocation/view_allo.js"></script>
<title>设备调拨单</title>
</head>
<body class="bdNone">
<div class="tabMid"> 
  ...
  <div class="feesSp fsMar">
    <table cellspacing="0" cellpadding="0" border="0" width="100%" >
      ...
      <tr>
        <td width="70" height="27" class="spTit" style="width:auto">设备名称：</td>
        <td width="128"><span name="deviceName">${devList.device.deviceName}</span><span name="purchaseId" style="display: none">${devList.id}</span></td>
        <td class="spTit" style="width:auto">设备编号：</td>
        <td width="150">${devList.device.deviceNO}</td>
        <td colspan="2">&nbsp;</td>
        <td rowspan="4">&nbsp;</td>
      </tr>
      <tr>
