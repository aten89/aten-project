...
<script type="text/javascript" src="page/device/allocation/tview_inuser.js"></script>
<script type="text/javascript" src="${ermpPath}/jqueryui/select/jquery.select.js"></script>
<title>设备调拨单</title>
</head>
<body class="bdNone">
<input type="hidden" id="id" value="${form.id }"/>
<input type="hidden" id="moveType" value="${form.moveType }"/>
<div class="tabMid"> 
  <!--故障编辑 end-->
  <div class="addCon">
  ...
  <div class="costsListHead">
    <div style="width:100%"><label  style="float:left">设备清单</label></div>
  </div>
  ...
  <div class="feesSp fsMar">
    <table cellspacing="0" cellpadding="0" border="0" width="100%" >
      ...
      <tr>
        <td class="spTit" height="27" style="width:auto">设备类别：</td>
        <td>${devList.device.deviceClass.name}</td>
        <td height="27" class="spTit" style="width:auto">设备型号：</td>
      ...
      <tr>
        ...
        <td><select name='areaSel' style='width:60px;height:20px'><script language="javaScript"> document.write (createAreaOption("m/data_dict?act=ereasel", "", "", "${devList.areaCode }")) </script></select></td>
        <td height="27" class="spTit" style="width:100px">&nbsp;</td>
        <td colspan="3">&nbsp;</td>
      </tr>
      </c:if>
    </table>
