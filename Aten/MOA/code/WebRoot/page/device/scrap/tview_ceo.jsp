...
<script type="text/javascript" src="page/device/scrap/tview_ceo.js"></script>
                  ...
                  <div class="shadow04">
                    <div class="shadowCon shadowPadd">
                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <tr>
                           <th width="100" class="sbRight">预期付款日期</th>
                          <td width="130" colspan="7"><fmt:formatDate value="${devList.planPayDate }" pattern="yyyy-MM-dd"/></td>
                        </tr>
                        </c:if>
                      </table>
                    </div>
