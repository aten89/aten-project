			...
			$.ajax({
				...
				success : function(xml){
				    ...
				    if (message.attr("code") == "1") {
						...
						var sHtml = createScrapDeviceDetailHTML(aScrapDevice);
 ...
 * 生成报废设备详情HTML
 */
function createScrapDeviceDetailHTML(scrapDevices) {
	var sHtml = "";
	$.each(scrapDevices, function(i, scrapDevice) {
	    ...
	    var dealTypeOptionsHTML = createDealTypeOption("m/data_dict?act=selectscrapdisposetypexml", "", "", "", $.trim(scrapDevice.buyType) == "BUY-TYPE-COMP");
	    ...
	    sHtml += "    <td class=\"spTit\"><span class=\"cRed\">*</span>报废原因：</td>";
