...
<script type="text/javascript" src="page/device/scrap/tview_usercfm.js"></script>
                    ...
                    <div class="shadowCon shadowPadd">
                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <th width="100" class="sbRight"><span class="cRed">*</span>是否回购</th>
                          <td width="130" colspan="3"><input name="buyFlag_${list.id }" type="radio" value="true" id="yes"  class="cBox" checked="checked" />
                            <label for="yes">是</label>
                            &nbsp;
                            <input name="buyFlag_${list.id }" type="radio" value="false" id="no" class="cBox" />
                            <label for="no">否</label></td>
                        </tr>
                        </c:if>
                        <c:if test="${list.dealType=='SCRAP_DISPOSE_LOSE'}">
                        <tr>
                           <th width="100" class="sbRight">预期付款日期</th>
                          <td width="130" colspan="7"><fmt:formatDate value="${list.planPayDate }" pattern="yyyy-MM-dd"/></td>
                        </tr>
                        </c:if>
                      </table>
                    </div>
