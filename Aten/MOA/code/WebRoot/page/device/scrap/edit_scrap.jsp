...
<script type="text/javascript" src="page/device/scrap/edit_scrap.js"></script>
</head>
<body class="oppBd">
  ...
  <div class="addCon">
    <table border="0" cellpadding="0"  cellspacing="1" width="100%">
      ...
      <tr>
        ...
        <td class="field" colspan="5"><select name='deviceTypeSel' style='width:100px;height:20px'><script language="javaScript">  
		  ...
		  <div class="feesSp fsMar">
		    <table cellspacing="0" cellpadding="0" border="0" width="100%" >
		      ...
		      <tr>
		        ...
		        <td width="128"><span name="deviceNO">${list.device.deviceNO }</span></td>
		        <td width="70"  class="spTit">设备名称：</td>
		        <td width="100">${list.device.deviceName }<span name="deviceID" style="display:none;">${list.device.id }</span></td>
		        ...
		        <td>
		        	...
		        	<c:choose>
		        		...
		        		<c:when test="${applyForm.formType=='1'}">
		        			document.write (createLeaveDealTypeOption("m/data_dict?act=leavedealtypesel","", "", "${list.dealType}", ""))
		        		</c:when>
		        	</c:choose>
		        		</script>
		        	</select>
		        </td>
		        <td class="spTit"><c:if test="${applyForm.formType=='0'}"><span class="cRed">*</span>报废</c:if>原因：</td>
