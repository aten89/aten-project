...
<script type="text/javascript" src="page/device/scrap/tview_compcfm.js"></script>
                    ...
                    <div class="shadowCon shadowPadd">
                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td colspan="7"><span name="spanInDate"><fmt:formatDate value="${devList.inDate }" pattern="yyyy-MM-dd"/></span></td>
                        </tr>
                        </c:if>
                        </c:if>
                        ...
                        <tr>
                         <th width="100" class="sbRight">预期付款日期</th>
                          <td width="130"><fmt:formatDate value="${devList.planPayDate }" pattern="yyyy-MM-dd"/></td>
                          <th width="100" class="sbRight">款项到账日期</th>
                          <td colspan="5"><span name="spanInDate"><fmt:formatDate value="${devList.inDate }" pattern="yyyy-MM-dd"/></span></td>
                        </tr>
                        </c:if>
                      </table>
                    </div>
