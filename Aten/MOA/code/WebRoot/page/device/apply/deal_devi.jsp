    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td style="width:120px">
             <div id="deviceFormTypeSel" name="deviceFormTypeSel"></div>
        </td>
...
<div class="allList alFix">
  <table id="FormList" width="100%" border="0" cellspacing="0" cellpadding="0">
    <thead id="tableTH">
      <tr>
...
<!--翻页 end-->
<script type="text/javascript" src="page/device/apply/deal_devi.js"></script> 
