...
<script type="text/javascript" src="page/cost/reimburse/view_reim.js"></script>
<title></title>
</head>
<body class="bdNone">
<textarea style="display:none" id="tmpCause">${reimbusement.causa}</textarea>
<c:forEach var="g" items="${reimbusement.reimItems}" >
	<c:forEach var="o" items="${g.outlayLists}" >
		<textarea style="display:none" id="tmp_${o.id}">${o.description}</textarea>
	</c:forEach>
</c:forEach>
<!--报销单审批-->
...
<div class="feesSp"></div>
	...
	<div class="addTool2">
		<input id="closeTab" class="allBtn" type="button" value="关闭"/>
	</div>
	<p>&nbsp;</p><p>&nbsp;</p>
</div>
	</div>	
