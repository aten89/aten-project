...
<script type="text/javascript" src="page/address/myaddr/view_addr.js"></script>
</head>
<body class="bdNone">
<input id="hidModuleRights" type="hidden" value="<oa:right key='my_addr'/>"/>
...
<div class="addCon">
	<table width="720" border="0" align="center" cellpadding="0"  cellspacing="1">
		...
		<tr>
			...
			<td><span id="userSex">${addrList.userSex == "F" ? "女" : (addrList.userSex == "M" ? "男" : "")}</span>
			</td>	
			<td class="tit">籍贯 
			</td>
		...
		<tr>
			...
			<td><span id="userBirthDate"><fmt:formatDate value="${addrList.userBirthDate }" pattern="yyyy-MM-dd"/></span>
		  	...
		  	<td><span id="userNation">${addrList.userNation }</span></td>
		</tr>		
		<tr>
			<td class="tit">家庭电话 
			</td>
