...
<script type="text/javascript" src="page/knowledge/kb/frame_assign.js"></script>
</head>
<body class="bdNone">

<input id="id" type="hidden" value="${knowClass.id }"/>
<input id="flag" type="hidden" value="${param.flag }"/>
<input id="title" type="hidden" value="${knowClass.name}"/>
