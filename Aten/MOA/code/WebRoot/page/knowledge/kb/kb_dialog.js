...
function FinalKnowledgeDialog(oa_path, base_path){
	this.oaPath = oa_path;
	...
	*/
	this.openDialog = function(knowledgeIds,act){
		...
		this.dialogWin = $.showModalDialog("知识点选择框", this.basePath + "page/knowledge/kb/kb_dialog.jsp", 342, 347, function(){
...
//		var ok = window.showModalDialog(this.basePath + "page/knowledge/kb/kb_dialog.jsp",this,"dialogWidth:376px;dialogHeight:391px;help:no;center:yes;status:no");
//		if (ok){
