...
<head>
	...
	<script language="javascript">
		...
		function initKnowledgeList(){
			var rootId = "";
			var rootText = "";
			if (args.act == "changetofinal") {
				rootId = "final_knowledge_id";
			 	rootText = "正式库";
			} else {
			 	rootId = "temp_knowledge_id";
			 	rootText = "临时库";
			}
			var rootNode = $(".root","#selTree");
			rootNode.attr("id", rootId);
			$('span:first',rootNode).text(rootText);
			...
			selectTree.refreshNode(rootNode, "m/knowledge?act=classtree&pid=" + rootId + "&flag=1");
		...
		function selectKnowledge(){
			...
			$.ajax({
				...
				cache: false,
		      	...
		      	dataType : "xml",
		      	data : {
		      		act : args.act,//changetype or changetofinal
		      		ids	: ids,
		      		parentId : parentId
		      	},
					...
					<div id="moduleDialog" style="padding:0 0 0 6px; margin:0">
						<div style="padding:0; margin:0">
							<ul id ="selTree" class="simpleTree" name="selTree" style="height:294px; width:248px">
								<li class="root" id="final_knowledge_id"><span id="rootTreeName">正式库</span>
									<ul class="ajax">
										<li>{url: }</li>
									</ul>
								</li>
