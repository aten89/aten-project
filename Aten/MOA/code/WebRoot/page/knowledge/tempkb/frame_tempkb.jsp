...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="page/knowledge/tempkb/frame_tempkb.js"></script>
		<script type="text/javascript" src="page/knowledge/tempkb/kb_dialog.js"></script>
	</head>
	<body>
		...
		<div class="subBk">
		   <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="theObjTable">
			  <tr>
				<th colspan="2" class="sub02">临时知识库<b id="titlName"></b></th>
			  </tr>
			  <tr>
				<td  class="subLeft">
					      ...
					      <tr>
					        <td style="padding-right:5px">
					           <ul class="simpleTree" id="leftTree" style="width:100%">
									<li class="root" id="temp_knowledge_id"><span>学习资料</span>
										<ul class="ajax">
											<li>{url:m/knowledge?act=classtree&pid=temp_knowledge_id}</li>
										</ul>
									</li>
								</ul> 
					        </td>
				...
				<div class="addTool" id="allTool">
				  <div class="t01">
					  ...
					  <input type="button" class="zzsk_btn" id="changeFinal"/>
