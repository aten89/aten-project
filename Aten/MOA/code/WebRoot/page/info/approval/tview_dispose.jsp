...
<script type="text/javascript"	src="page/info/approval/tview_dispose.js"></script>
<title></title>
</head>
<body class="bdNone">
...
<div class="addCon">
  ...
  <tr>
    ...
    <tr>
     <td class="tit">内&nbsp;&nbsp;&nbsp;&nbsp;容</td>
       <td colspan="5" id="contentSet">        	<a href="javascript:void(0)" id="fullScrean" style="font-weight:bold;text-decoration:underline">全屏查看</a></td>
   </tr>
  <tr>
