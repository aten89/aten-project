...
//  					var ok = window.showModalDialog(BASE_PATH + "page/ArchivesApprove/DispatchManage/PersonDialog.jsp", arg, "dialogHeight:270px;dialogWidth:360px;status:no;scroll:auto;help:no");
//  					if(ok){
...
function initControl(){
	...
	NTKO_ATTACH_OCX.setPermission({view:true,add:true,update:true,del:false,saveas:true});
...
function saveDraftDoc(){
	...
	var signGroupNames = $.trim($("#signGroupNames").html());
	$.ajax({
         type : "POST",
        cache: false,
        async: false,
