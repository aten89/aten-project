...
<script type="text/javascript" src="page/doc/paramconf/sort_class.js"></script>
</head>
<body class="bdNone">
		  ...
		  <tr>
			<td id="kjfsh">
			   ...
			   <table align="center" border="0" cellspacing="0" cellpadding="0" class="tabNone">
				  <tr>
					<td width="230" >
					<select id="docClasses" name="docClasses" size="20" class="pxSel01" style="height:300px; width:250px">
					</select>
					</td>
					<td width="70">
