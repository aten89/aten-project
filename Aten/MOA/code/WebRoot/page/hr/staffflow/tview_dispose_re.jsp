...
<title></title>
<script type="text/javascript" src="page/hr/staffflow/tview_dispose_re.js"></script>
...
<!--请假单-->
  ...
  <table width="100%"  border="0" align="center" cellpadding="0"  cellspacing="1">
	...
	<c:if test="${not empty param.notify}">   
			<input type="button" value="添加知会人" class="allBtn" onclick="addFlowNotify('${sessionUser.displayName }','审批的离职申请', 'LZLC', '/m/staff_arch?act=toview&id=');" style="margin-left:50px"/>&nbsp;&nbsp;
