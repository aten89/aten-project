...
<script type="text/javascript" src="page/hr/staffflow/query/draft_entry.js"></script>
</head>
<body class="tabBd" scroll="no">
<input type="hidden" id="applyType" value="${staffFlowApply.applyType}"/>
<input type="hidden" name="id" id="staffid" value="${staffFlowApply.id}"/>
<div class="tabScroll" style="bottom:0px;_bottom:0px;">
  ...
  <div class="addCon" style="padding:8px">
    <table width="100%" border="0" align="center" cellpadding="0"  cellspacing="1">
      ...
      <tbody id="staffInfo1">
	      <tr>
	        <td class="tit">填 写 人</td>
	        <td>${staffFlowApply.applicantName}</td>
	        <td class="tit"><span class="cRed" valid="userName">*</span>员工姓名</td>
	        <td>
	          <div style="float:left">
				<input id="userName" readonly maxlength="40" type="text" style="width:75%" class="ipt01" value="${staffFlowApply.userName}"/>
				<input type="button" id="openUserSelect" class="selBtn"/>
			  </div>
	        </td>
	        <td class="tit"><span class="cRed" valid="employeeNumber">*</span>工 号</td>
	        <td>
	          <input id="employeeNumber" readonly maxlength="40" type="text" class="ipt01" value="${staffFlowApply.employeeNumber}"/>
	        </td>
	      </tr>
	      <tr>
	      ...
	      <tr>
	        ...
	        <td>
	          <input id="age" maxlength="40" type="text" class="ipt01" value="${staffFlowApply.age}"/>
	    	</td>
	      </tr>
	      <tr>
  ...
  <br/>
  <div class="addTool2">
	<input id="saveAsDraft" type="button" value="保存" class="allBtn"/>
  </div>
  <br/>
</div>
</body>
