...
<script type="text/javascript" src="page/hr/staffflow/query/view_entry.js"></script>
</head>
<body class="bdNone">
                          ...
                          <div class="spyjCon">
                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
						      ...
						      <tr>
						        ...
						        <td colspan="3">${staffFlowApply.bankType}</td>
						      </tr>
                            </table>
                          </div>
                        </div>
                        ...
                        <div class="spyjConBk">
                          <div class="spyjCon">
                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
						      ...
						      <tr>
						      	<td class="tit"><span class="cRed">*</span>是否生育</td>
						        <td colspan="5">${staffFlowApply.hadKids == '1' ? '是':'否'}</td>
						      </tr>
                            </table>
                          </div>
                        </div>
                        ...
                        <div class="spyjConBk">
                          <div class="spyjCon">
                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
						      ...
						      <tr>
						      	<td class="tit"><span class="cRed" valid="degree">*</span>学 位</td>
						        <td colspan="5">${staffFlowApply.degree}</td>
						      </tr>
                            </table>
                          </div>
                        </div>
                        ...
                        <div class="spyjConBk">
                          <div class="spyjCon">
                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                              <tr>
						        <td>
						          <textarea id="trainInfo" readonly class="area01" style="height:250px">${staffFlowApply.trainInfo}</textarea>
						        </td>
						      </tr>
                            </table>
                          </div>
                        ...
                        <div class="spyjConBk">
                          <div class="spyjCon">
                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                              <tr>
						        <td>
						          <textarea id="skillsInfo" readonly class="area01" style="height:250px">${staffFlowApply.skillsInfo}</textarea>
						        </td>
						      </tr>
                            </table>
                          </div>
