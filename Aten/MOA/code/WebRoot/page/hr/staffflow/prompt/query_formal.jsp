...
<div class="soso">
<input id="hidModuleRights" type="hidden" value="<oa:right key='staff_positive'/>"/>
...
<table id="DeviceList" width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:auto">
  <thead>
    <tr>
		<th width="12%">姓名</th>
		<th width="12%">工号</th>
		<th width="14%">距离转正天数</th>
		<th width="14%">待转正日期</th>
		<th width="12%">员工状态</th>
		<th width="30%">所属部门</th>
		<th width="6%">操作</th>
	</tr>
...
<!--翻页 end-->
<script type="text/javascript" src="page/hr/staffflow/prompt/query_formal.js"></script>
