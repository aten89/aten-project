...
<div class="soso">
<input id="hidModuleRights" type="hidden" value="<oa:right key='staff_contract'/>"/>
...
<table id="DeviceList" width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:auto">
  <thead>
    <tr>
		<th width="10%">姓名</th>
		<th width="10%">工号</th>
		<th width="12%">合同结束日期</th>
		<th width="12%">距离结算天数</th>
		<th width="13%">合同类型</th>
		<th width="10%">员工状态</th>
		<th width="27%">所属部门</th>
		<th width="6%">操作</th>
...
<!--翻页 end-->
<script type="text/javascript" src="page/hr/staffflow/prompt/query_contr.js"></script>
