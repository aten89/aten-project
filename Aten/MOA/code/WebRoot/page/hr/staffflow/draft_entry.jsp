...
<script type="text/javascript" src="page/hr/staffflow/draft_entry.js"></script>
...
<div class="tabScroll" style="bottom:0px;_bottom:0px;">
  ...
  <div class="addTool2">
	...
	<input type="button" value="添加知会人" class="allBtn" onclick="addFlowNotify($('#applicantName').text(),'提交的入职申请', 'RZLC', '/m/staff_arch?act=toview&id=');"/>&nbsp;
