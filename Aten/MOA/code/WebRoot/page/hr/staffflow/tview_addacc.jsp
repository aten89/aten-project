...
<title></title>
<script type="text/javascript" src="page/hr/staffflow/tview_addacc.js"></script>
...
<!--请假单-->
  ...
  <table width="100%" border="0" align="center" cellpadding="0"  cellspacing="1">
	  ...
	  <tbody id="staffInfo1">
	      ...
	      <tr>
	      	<td class="tit"><span class="cRed">*</span>预开帐号</td>
	        <td colspan="5"><input id="userAccountID" readonly maxlength="40" type="text" style="width:140px" class="ipt01" value="${staffFlowApply.userAccountID}"/></td>
  ...
  <table width="100%"  border="0" align="center" cellpadding="0"  cellspacing="1">
	...
	<c:if test="${not empty param.notify}"> 
		  <input type="button" value="添加知会人" class="allBtn" onclick="addFlowNotify('${sessionUser.displayName }','开通入职者账号', 'RZLC', '/m/staff_arch?act=toview&id=');" style="margin-left:50px"/>&nbsp;&nbsp;
