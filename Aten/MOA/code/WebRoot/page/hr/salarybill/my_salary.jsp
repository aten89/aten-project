...
<body class="bdNone">
<input type="hidden" id="curMonth" value="${param.month}"/>
<div class="tabMid">
<!--请假单-->
  <div class="addCon">
	<table width="100%" border="0" align="center" cellpadding="0"  cellspacing="1">
		...
		<tr>
			<th colspan="6">我的工资条：
			  <select id="yearSel" onchange="changeSalary();" class="sel02" style="width:65px"></select>
			  <select id="monthSel" onchange="changeSalary();" class="sel02" style="width:50px">
...
<c:if test="${not empty salaryBill}">  
	  <tr> 	
