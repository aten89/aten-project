...
<head>
	...
	<script language="javascript">
			...
			$.getJSON(url,function(data){
				...
				$("#groupsList").simpleTree({
	                ...
	                afterClick: function(o){
	                    ...
	                    var groupPath = "";
	                    $(o).parents("li:not(.root)").each(function(){
	                    	groupPath += $(this).find("span:first").text() + "/";
	                    });
	                    groupPath += groupName;
	                    
	                   // alert($(o).parent(".text").text());
	                    selectedDept = {id:groupId,name:groupName,path:groupPath};
	               	}
	            });
			});
		}
		...
		function clearDept(){
			...
			args.selected.push({id:"", name:"",path:""});
			parent.window.returnValue1 = true;
			args.closeDialog();
		}
	</script>
