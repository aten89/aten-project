 ...
 * @author zsy
 */
public class DeptLeaderDecision implements IDecisionHandler {
	
	private static final Log log = LogFactory.getLog(DeptLeaderDecision.class);
	
	@Override
	public String decide(Execution exe) throws HandlerException {
		log.info("DeptLeaderDecision:" + exe.getNode().getName());
		try {
