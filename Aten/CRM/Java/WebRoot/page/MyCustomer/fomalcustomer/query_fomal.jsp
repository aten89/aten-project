...
<script type="text/javascript" src="page/MyCustomer/fomalcustomer/query_fomal.js"></script>
</head>

<body class="bdNone">
<input id="hidModuleRights" type="hidden" value="<eapp:right key='FORMAL_CUST'/>" />
<div class="soso">
  <div class="t01">
  <table border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		...
		<td>推荐产品：</td>
		<td class="soPaddRight"><input id="recommendProd" type="text" maxlength="50" class="ipt05"/>&nbsp;&nbsp;</td>
		<td>
