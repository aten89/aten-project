...
<script type="text/javascript" src="page/report/hr/rpt_grtj.js"></script>
    ...
    <table cellspacing="0" cellpadding="0" border="0" >
      <tbody>
        <tr>
          <td>查询时间段：</td>
          <td>
          	<input readonly id="bgnTransferDate" type="text" class="invokeBoth" style="width:70px"/>
			到<input readonly  id="endTransferDate" type="text" class="invokeBoth" style="width:70px"/>&nbsp;&nbsp;
		  </td>
		  <td>所属团队：</td>
        ...
        <tr style="height:26px">
          <td>业绩金额：</td>
          <td>
          	<input id="bgnTransferAmount" type="text" class="ipt05" style="width:94px"/>
          	到<input id="endTransferAmount" type="text" class="ipt05" style="width:94px"/>&nbsp;&nbsp;</td>
          <td>是否在职：</td>
          <td>
